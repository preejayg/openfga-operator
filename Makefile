...
# aspectinfotech.com/openfga-operator-bundle:$VERSION and aspectinfotech.com/openfga-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= aspectinfotech.com/openfga-operator
